...
(function (global) {
  ...
  var STRINGS = {
    'zh': {
      ...
      'settings.title':      '设置',
      'settings.preset':     '预设',
      'settings.preset_default':'预设服务',
      'settings.preset_custom':'自定义',
      'settings.baseurl':    'Base URL',
      'settings.baseurl_hint':'OpenAI 兼容接口的根地址。选择"预设服务"时无需填写，由服务器配置提供。自定义时需同时填写 Base URL、API Key 与模型。',
      ...
      'welcome.f2.t':        '开箱即用',
      'welcome.f2.d':        '已默认接入预设模型，无需配置直接开聊',
      'welcome.f3.t':        '完全自定义',
    ...
    'en': {
      ...
      'settings.preset_default':'Preset service',
      'settings.preset_custom':'Custom',
      'settings.baseurl':    'Base URL',
      'settings.baseurl_hint':'OpenAI-compatible endpoint root. Not needed for "Preset service" — the server config provides it. For Custom, fill Base URL, API Key and Model.',
      'settings.apikey':     'API Key',
      ...
      'welcome.f2.d':        'A default model is pre-configured. Just start typing.',
